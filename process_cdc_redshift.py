...
s3_location = "s3://sesse-uswest2/capstone-dataengineer_3"
...
# to_date(cdc_case_earliest_dt, 'YYYY-MM-DDTHH:MI:SS.MS') 
# select cdc_case_earliest_dt, to_date(cdc_case_earliest_dt, 'YYYY-MM-DDTHH:MI:SS.MS') from stage_cdc limit 10

# select race_ethnicity_combined,  SPLIT_PART(race_ethnicity_combined, ',', 1) from stage_cdc limit 10;
